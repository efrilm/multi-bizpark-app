...
import 'package:multibizpark/pages/sales_page/actions/add_reservation_page.dart';
import 'package:multibizpark/pages/sales_page/actions/add_tracking.dart';
...
import 'package:multibizpark/widgets/visit_date_card.dart';
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            AddReservation(widget.model.leadId)));
              },
              text: "Reservasi",
            ),
          ],
